...
variable "fw_count" {
  description = "Number of firewalls to be deployed per AZ"
  type = number
}

variable "ins_vpc_cidr" {
  description = "CIDR of Inspection VPC"
  type = string
}

variable "ins_vpc_name" {
  description = "Name of Inspection VPC"
  type = string
}
...
variable "tgw_subnets" {
  description = "Subnets used by the TGW Endpoints in the ascending order of AZs"
  type = list
}

variable "gwlbe_subnets" {
  description = "Subnets used by the GWLB Endpoints in the ascending order of AZs"
  type = list
}

variable "natgw_subnets" {
  description = "Subnets used by the NAT Gateway in the ascending order of AZs"
  type = list
}

variable "fw_data_subnets" {
  description = "Subnets used by the data ENI of firewalls in the ascending order of AZs"
  type = list
}

variable "fw_mgmt_subnets" {
  description = "Subnets used by the MGMT ENI of firewalls in the ascending order of AZs"
  type = list
}
